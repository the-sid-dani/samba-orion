...
* Add support for Streamable HTTP Transport [#56](https://github.com/the-sid-dani/samba-orion/issues/56) ([#64](https://github.com/the-sid-dani/samba-orion/issues/64)) ([8783943](https://github.com/the-sid-dani/samba-orion/commit/878394337e3b490ec2d17bcc302f38c695108d73))
...
* implement strategic dual branding for Samba-Orion while preserving upstream compatibility ([c673ca0](https://github.com/the-sid-dani/samba-orion/commit/c673ca028d87887c7afd72f1170052ec4fe08bbf))
...
* theme-aware branding + docs restructure ([6cce9bd](https://github.com/the-sid-dani/samba-orion/commit/6cce9bd930cc36b5ebeda06e80224b8bc382f2c6))
...
* update branding to Samba Agentic Audiences ([561a406](https://github.com/the-sid-dani/samba-orion/commit/561a406d5c41251ddcbe7f50deed7ab04a5c17c9))
...
* **voice:** deliver tool summary plus full data to realtime model ([cf925f8](https://github.com/the-sid-dani/samba-orion/commit/cf925f8268255c27922d477dd1d501260ad36b0b))
...
* add global error interceptor to diagnose idle crashes ([26e1c2a](https://github.com/the-sid-dani/samba-orion/commit/26e1c2acbdda9bb7d39ff5a520e783932cbad567))
...
* add unoptimized prop to SVG logos for production rendering ([57975cb](https://github.com/the-sid-dani/samba-orion/commit/57975cbcfb567572b0453904a7de293056eeba03))
* address code review findings for chat persistence ([8a14b5c](https://github.com/the-sid-dani/samba-orion/commit/8a14b5c3e5d4a1ec3e1180f4c6d9acaa9a165595))
...
* exclude samba-resources from middleware to allow static assets on auth pages ([568524c](https://github.com/the-sid-dani/samba-orion/commit/568524c21551dfb51264b05d4701a8db8836d5ed))
...
* handle cumulative text fallback when step.text is empty ([fdfc072](https://github.com/the-sid-dani/samba-orion/commit/fdfc072246feb859f4235baa512182e4ebc08a0d))
...
* idle error recovery with WebGL context handling ([2f5bfb0](https://github.com/the-sid-dani/samba-orion/commit/2f5bfb0515c1520f7e5c2eb97e29395c7b72f12b))
* idle timeout error prevention - code review fixes ([c0e5ae5](https://github.com/the-sid-dani/samba-orion/commit/c0e5ae584e744197404a6904cab467fd896b4096))
* ignore tool binding on unsupported models (server-side) ([#160](https://github.com/the-sid-dani/samba-orion/issues/160)) ([277b4fe](https://github.com/the-sid-dani/samba-orion/commit/277b4fe986d5b6d9780d9ade83f294d8f34806f6))
...
* preserve correct order of parts - tool calls before text ([9199b66](https://github.com/the-sid-dani/samba-orion/commit/9199b66dac340d2507f3fae846204892d7a33e81))
...
* **prompts:** add data-driven chart selection decision tree to prevent bar chart overuse ([3af62fb](https://github.com/the-sid-dani/samba-orion/commit/3af62fb4326226e33ea736e40dd685ceeda7838e))
...
* resolve 3 bugs in idle detection system ([0522c1c](https://github.com/the-sid-dani/samba-orion/commit/0522c1c10a69d0781c19c0468df2df34a51090f7))
* resolve 81 TypeScript errors for chat persistence ([3e23f7a](https://github.com/the-sid-dani/samba-orion/commit/3e23f7ad4057ddbc4e8e6e7f54a89301c8aa34ee))
...
* restore tool call persistence - remove overly aggressive filters ([f61fb60](https://github.com/the-sid-dani/samba-orion/commit/f61fb60ba63aaa3b9bf179e3ba4f6d4642871959))
...
* **tests:** resolve test failures from code review ([0c6ec1c](https://github.com/the-sid-dani/samba-orion/commit/0c6ec1c6ee7738a519c1f9bf8412a098c6a6e2c9))
...
* update sign-out behavior to redirect to sign-in page instead of reloading the window for improved user experience ([3001591](https://github.com/the-sid-dani/samba-orion/commit/30015915e9c53a047451bc1501148918f0a941b7))
...
* use correct Vercel AI SDK field names for tool calls ([d586c88](https://github.com/the-sid-dani/samba-orion/commit/d586c88c161388d9de5fa9adbbfc9be42c6236ec))
...
* wrap WebGL Renderer creation in try-catch to prevent crash ([a443803](https://github.com/the-sid-dani/samba-orion/commit/a4438032402b40de799964cd9995bb9ef228e644))
